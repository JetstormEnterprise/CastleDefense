...
public class DarkBow extends Bow {

    public DarkBow(short x, short y, int screenX, int screenY) {
    ...
    public void hitEnemy(Enemy enemy, PixelShot pixelShot) {
        ...
        if (random.nextInt(100) <= chanceForEffect && !enemy.isBoss()) {
            pixelShot.hit(enemy.hit(999999999, pixelShot.getUniqueShot(), shotType));
        } else {
